# https://github.com/chvancooten/NimPlant/blob/main/client/util/risky/dinvoke.nim
...
proc GetSyscallStub*(functionName: LPCSTR, syscallStub: LPVOID): BOOL =
    ...
    var addressOfNames = cast[ptr UncheckedArray[DWORD]](RVAtoRawOffset(cast[DWORD_PTR](fileData) + cast[DWORD_PTR](exportDirectory.AddressOfNames), rdataSection))
